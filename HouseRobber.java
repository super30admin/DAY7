public class HouseRobber {
    // we will be using dyanmic programming to solve this problem. This would be requiring two variables prev and current that would store the current and previous house maximum value that can be obtained.
    // Time complexity: O(n)
